...
process.env.STRIPE_KEY = 'sk_test_51MTy7AB0tHsNqxZPhtalCDD93x7gLf2szB5LHqZIiXp8sZrcvrGKlIkShKuaYBnLJ8rA4lYR3SivX1SQhLZTlJQv006ZGkPq10';
...
global.signin = (id? : string) => {
    ...
    const payload = {
        id: id || new mongoose.Types.ObjectId().toHexString(), //generate an id using mongoose, //any id works
